...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    public OrdreTravail DemandeByid(int id){
        ...
        c.moveToNext();
        OrdreTravail di=new OrdreTravail(c.getInt(6),c.getString(1),c.getInt(2),c.getInt(5),c.getInt(8),c.getInt(9),c.getInt(c.getColumnIndex("demandeCloture")),c.getInt(c.getColumnIndex("demandeLance")));
        return di;
    }
