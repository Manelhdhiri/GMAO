...
public class ListeDemandeParTech extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener {
    ...
    /*Login*/
    final  String METHOD_NAME = "ListeDMByTech";
    final String SOAP_ACTION = "http://tempuri.org/ListeDMByTech";
    Date dateU= null;
    Date dateDay= null;
    String NBT;
    String Id_Machine,NBTAttiribue,Name;
    String Id_Type_Trv;
    String desc;
    String Date_Demande;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_liste_demande_par_tech);
        ...
        navigationView.setCheckedItem(R.id.menu_ListeDemParTech);
        ...
        {
            new MyAsyncTask().execute(String.valueOf(idEmploye));
        }
        else {
    ...
    public void ListeId() {
        Cursor Liste = db.ListeDemandeParTechId(idEmploye,search.getText().toString());

        while (Liste.moveToNext()) {
            View tableRow = LayoutInflater.from(this).inflate(R.layout.layout_item, null, false);
            ...
            TextView actions = (TextView) tableRow.findViewById(R.id.textView5);
            ...
            while (c.moveToNext()) {
                if (c.getInt(0) == 1 && c.getInt(1) == 0) {
                    dateD.setBackgroundColor(Color.BLUE);
                    dateD.setTextColor(Color.WHITE);
                }
                if (c.getInt(0) == 1 && c.getInt(1) == 1) {
                    dateD.setBackgroundColor(Color.parseColor("#FF033A05"));
                    dateD.setTextColor(Color.WHITE);
                }
                if (c.getInt(0) == 1 && c.getInt(1) == 1 && c.getInt(2) == 1) {
                    dateD.setBackgroundColor(Color.parseColor("#FF4CAF50"));
                    dateD.setTextColor(Color.WHITE);
                }
            }
            ...
            while (cNL.moveToNext()) {
                dateD.setBackgroundColor(Color.RED);
                dateD.setTextColor(Color.WHITE);
            }
            ...
            actions.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Intent intent = new Intent(ListeDemandeParTech.this, DetailDIActivity.class);
            ...
            modif.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Intent intent = new Intent(ListeDemandeParTech.this, ModifierActivity.class);
                    intent.putExtra("idDI", Integer.parseInt(numOT.getText().toString()));
                    intent.putExtra("nomDM", var);
                    intent.putExtra("idEmploye", idEmploye);
                    intent.putExtra("role", role);
    ...
    public void Liste() {
        Cursor Liste = db.ListeDemandeParTech(idEmploye);
    ...
    private class MyAsyncTask extends AsyncTask<String,Void,String>
    {
        ...
        protected String doInBackground(String... strings) {
            ...
            Nom_emetteur.setValue(strings[0]);
        ...
        protected void onPostExecute(String s) {
            ...
            {
                Toast.makeText(ListeDemandeParTech.this, "No Date To Show", Toast.LENGTH_SHORT).show();
    ...
    public void affiche()
    {
        for(int  j=0;j<LNBT.size();j++)
        {
            ...
            if((LLance.get(j)).equals("non") && (LCloture.get(j)).equals("non") && (LApprouve.get(j)) && (new Date().after(dateU)))
            {
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if (id == R.id.menu_ListeDemParTech) {
            Toast.makeText(this, "Vous êtes déja en page de liste des demandes par technicien", Toast.LENGTH_SHORT).show();
        }
        ...
        if (id == R.id.menu_BonInventaire) {
            Intent intent = new Intent(ListeDemandeParTech.this, BonInventaireActivity.class);
            intent.putExtra("nomDM",var);
            intent.putExtra("idEmploye",idEmploye);
            intent.putExtra("role", role);
            startActivity(intent);
        ...
        if (id == R.id.menu_ListeBI) {
            Intent intent = new Intent(ListeDemandeParTech.this, ListeBonInventaireActivity.class);
            intent.putExtra("nomDM",var);
            intent.putExtra("idEmploye",idEmploye);
            intent.putExtra("role", role);
            startActivity(intent);
