...
public class EcheanceParUsage extends AppCompatActivity implements View.OnClickListener, AdapterView.OnItemSelectedListener , NavigationView.OnNavigationItemSelectedListener {
    ...
    String   typeOp;
    int idTT,idGamme, idOp,idSec,idExec,idMachine;
    String idOt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_echeance_par_usage);
        ...
        navigationView.setCheckedItem(R.id.menu_listeEchUsage);
    ...
    public void cursor(Cursor c)
    {
        ...
        while (c.moveToNext()) {
            View tableRow = LayoutInflater.from(this).inflate(R.layout.layout_table_ech_usage, null, false);
            ...
            TextView usageEc=(TextView) tableRow.findViewById(R.id.usageEnCours);
            TextView usagePrc=(TextView) tableRow.findViewById(R.id.usageProchain);
            ...
            btGenerer.setText(c.getString(9));
            usageEc.setText(c.getString(7));
            usagePrc.setText(c.getString(8));
            ...
            if(!checkNetworkConnection()) {
                btGenerer.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View v) {
                        if (!btGenerer.getText().toString().equals("")) {
                            Intent intent = new Intent(EcheanceParUsage.this, ModifierActivity.class);
                            ...
                            Toast.makeText(EcheanceParUsage.this, "il faut generé un Ot", Toast.LENGTH_SHORT).show();
                        }
                    }
                        ...
                        bt.setOnClickListener(new View.OnClickListener() {
                            ...
                            public void onClick(View v) {
                                ...
                                for (int i = 0; i < array.size(); i++) {
                                    ...
                                    Cursor c2 = db.AllIdEchUsage(array.get(i));
                                    while (c2.moveToNext()) {
                                        idTT = c2.getInt(0);
                                        idGamme = c2.getInt(2);
                                        idOp = c2.getInt(3);
                                ...
                                if (update[0]) {
                                    AlertDialog.Builder builder = new AlertDialog.Builder(EcheanceParUsage.this);
                                ...
                                if (idOt != null) {
                                    Toast.makeText(EcheanceParUsage.this, "Ot deja generé", Toast.LENGTH_SHORT).show();


                                }
                                if (update[0] = false) {
                                    Toast.makeText(EcheanceParUsage.this, "not updated !", Toast.LENGTH_SHORT).show();
                                }
    ...
    public void afficheTous()
    {
        ...
        Cursor Liste=db.ListeEcheanceUsage();
    ...
    {  int idEq=0,idSec=0;
        ...
        if(!spinnerDesignation.getSelectedItem().toString().equals("")) {
            ...
            c = db.filtrageEchUsage(etDatedb.getText().toString(), etDatefin.getText().toString(), idEq);
            if(!etSection.getSelectedItem().toString().equals(""))
            {
                ...
                c = db.filtrageAllEchUsage(etDatedb.getText().toString(), etDatefin.getText().toString(), idEq,idSec);
        ...
        else if(!etSection.getSelectedItem().toString().equals("") && spinnerDesignation.getSelectedItem().toString().equals(""))
        {
            ...
            c = db.filtrageEchUsageWithSection(etDatedb.getText().toString(), etDatefin.getText().toString(),idSec);

        }
        else {
            c = db.filtrageEchUsageWithoutEquip(etDatedb.getText().toString(), etDatefin.getText().toString());
        }
        cursor(c);
    }
    ...
    private void showDateTimeDialog(EditText editText) {
        ...
        DatePickerDialog.OnDateSetListener dateSetListener = new DatePickerDialog.OnDateSetListener() {
            ...
            public void onDateSet(DatePicker view, int year, int month, int dayOfMonth) {
                ...
                new TimePickerDialog(EcheanceParUsage.this, timeSetListener, cldr.get(Calendar.HOUR_OF_DAY), cldr.get(Calendar.MINUTE), false).show();
            }
        };

        new DatePickerDialog(EcheanceParUsage.this, dateSetListener, cldr.get(Calendar.YEAR), cldr.get(Calendar.MONTH), cldr.get(Calendar.DAY_OF_MONTH)).show();
    }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        ...
        if(id == R.id.menu_home){
            Intent intent = new Intent(EcheanceParUsage.this,StatisticActivity.class);
            intent.putExtra("nomDM",var);
            intent.putExtra("idEmploye",idEmploye);
            intent.putExtra("role", role);
        ...
        if(id == R.id.menu_DMInt){
            Intent intent = new Intent(EcheanceParUsage.this,DIActivity.class);
            intent.putExtra("nomDM",var);
            intent.putExtra("role", role);
            intent.putExtra("idEmploye",idEmploye);
            startActivity(intent);
        ...
        if(id == R.id.menu_ListeDM){
            Intent intent = new Intent(EcheanceParUsage.this,AccueilActivity.class);
            intent.putExtra("nomDM",var);
            intent.putExtra("role", role);
            intent.putExtra("idEmploye",idEmploye);
            startActivity(intent);
        ...
        if (id == R.id.menu_ReleveUsages) {
            Intent intent = new Intent(EcheanceParUsage.this, ReleveUsages.class);
            intent.putExtra("nomDM",var);
            intent.putExtra("role", role);
            intent.putExtra("idEmploye",idEmploye);
            startActivity(intent);
        ...
        if (id == R.id.menu_BonSortie) {
            Intent intent = new Intent(EcheanceParUsage.this, BonSortie.class);
            intent.putExtra("nomDM",var);
            intent.putExtra("role", role);
            intent.putExtra("idEmploye",idEmploye);
            startActivity(intent);
        ...
        if (id == R.id.menu_ListeBS) {
            Intent intent = new Intent(EcheanceParUsage.this, ListeBonSortie.class);
            intent.putExtra("nomDM",var);
            intent.putExtra("role", role);
            intent.putExtra("idEmploye",idEmploye);
            startActivity(intent);
        ...
        if (id == R.id.menu_BonInventaire) {
            Intent intent = new Intent(EcheanceParUsage.this, BonInventaireActivity.class);
            intent.putExtra("nomDM",var);
            intent.putExtra("role", role);
            intent.putExtra("idEmploye",idEmploye);
            startActivity(intent);
        ...
        if (id == R.id.menu_ListeBI) {
            Intent intent = new Intent(EcheanceParUsage.this, ListeBonInventaireActivity.class);
            intent.putExtra("nomDM",var);
            intent.putExtra("role", role);
            intent.putExtra("idEmploye",idEmploye);
            startActivity(intent);
